...
export default function intro() {
    return (
        <Intropage>
            <h2>Introduction</h2>
            <p>HARPG (Horse Art Roleplay Game) is an RPG based online game, where
            ...
            Tokotas, DracoStryx and World-of-Reos. <br /><br />
            ...
            designing side of the game to help newcomers and veterans alike.</p>
        </Intropage>
    )
}